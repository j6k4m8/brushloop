...
Deploy without installing Flutter on the host:
...
- Dockerized Flutter web build (`web-build` service)
- API + edge startup (`api`, `edge`)

The web domain serves the Flutter build from `deploy/web` (generated by the containerized build step).
